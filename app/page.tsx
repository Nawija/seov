    ...
    <>
      ...
      <section className="relative container mx-auto overflow-hidden px-6 py-20">
        <div className="relative z-10 mx-auto max-w-5xl text-center">
          <div className="mb-8">
            <span className="mb-6 inline-block rounded-full border border-blue-200/50 bg-gray-50 px-6 py-2 text-sm font-semibold text-blue-600 shadow-xl">
          ...
          <p className="mx-auto mb-12 max-w-3xl text-sm leading-relaxed text-gray-700/90 md:text-base">
